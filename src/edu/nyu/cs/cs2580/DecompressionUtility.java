...
public class DecompressionUtility {
	...
	public static void printUtility(List<Integer> input) {
		for(int i = 0; i < input.size(); i++) {
			System.out.println(input.get(i));
		}
	}
	
	public List<Integer> decodeByteAlign(List<Character> encodedList) {
		
		if(encodedList == null || encodedList.size() == 0)
			return null;

		List<Integer> listOfDecimalNos = new ArrayList<Integer>();
		StringBuffer sb;
		int i = 0;
		int pos = 0;
		String binaryBlock1 = "";
